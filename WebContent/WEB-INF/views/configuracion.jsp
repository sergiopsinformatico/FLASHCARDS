	...
	<body>
		...
		<div class="row">
			...
			<div class="col-md-5 center">
				<div class="card text-white bg-danger mb-3" style="height: 350px; max-width: 100%;">
					<div class="card-body">
							<form action="eliminar.html?usuario=${usuario.getUsuario()}">
								<button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" onclick="return confirm('¿Desea Eliminar la Cuenta?');">
									Eliminar Cuenta<span class="border border-primary"></span>
								</button>
							</form>
