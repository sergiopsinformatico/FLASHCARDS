				...
				<div class="col-sm-5">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<small id="creadorHelp" class="form-text text-muted">Máximo 250 caracteres. {{ newAnverso.length }} carácteres de 250 carácteres.</small>
						</div>
						<div class="form-group">
							...
							<small id="creadorHelp" class="form-text text-muted">Máximo 250 caracteres. {{ newReverso.length }} carácteres de 250 carácteres.</small>
						</div>
