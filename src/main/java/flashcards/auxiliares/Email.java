...
public class Email {
	...
	public boolean confirmaCreaCuenta(UsuarioDTO user) {
		...
		//Mensaje
		setMensaje("Bienvenido a la Aplicaci髇 Flashcards!!"+
	...
	public boolean eliminarCuenta(UsuarioDTO user, String fecha) {
        ...
        "\nSu cuenta va a proceder a eliminarse por completo el "+fecha+"."+
		 "\nSi accede antes al sistema con su cuenta, su cuenta no ser谩 eliminada."+
	...
	public boolean recuperarClave(UsuarioDTO user) {
		//Asunto
		setAsunto("[Sistema Flashcards] Recuperaci贸n de la clave de "+user.getEmail());
		//Mensaje
		setMensaje("Hola "+user.getNombreApellidos()+"!!"+
		"\nHa solicitado recuperaci贸n de sus datos de su cuenta en Flashcards:"+
		"\nUsuario: "+user.getEmail()+" o "+user.getUsername()+
		"\nClave: "+user.getClave()+
		"\nAtentamente, Equipo de Gesti贸n de Sistema Flashcards.");
		//Email de quien recibe el mensaje
		setRecibe(user.getEmail());
		return enviarMensaje();
	}
	...
	public boolean reactivacionCuenta(UsuarioDTO user) {
		...
		//Mensaje
		setMensaje("Hola "+user.getNombreApellidos()+"!!"+
		"\nSu cuenta en Flashcards, se ha reactivado y no ser谩 borrada:"+
		"\nUsuario: "+user.getEmail()+" o "+user.getUsername()+
		"\nClave: "+user.getClave()+
		"\nAtentamente, Equipo de Gesti贸n de Sistema Flashcards.");
		//Email de quien recibe el mensaje
